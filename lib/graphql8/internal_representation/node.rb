...
module GraphQL8
  module InternalRepresentation
    class Node
      ...
      # Each key is a {GraphQL8::ObjectType} which this selection _may_ be made on.
      ...
      # @return [Hash<GraphQL8::ObjectType, Hash<String => Node>>]
      def typed_children
      ...
      # @return [Hash<GraphQL8::BaseType, Hash<String => Node>>]
      attr_reader :scoped_children

      # @return [Array<Language::Nodes::AbstractNode>] AST nodes which are represented by this node
      attr_reader :ast_nodes

      # @return [Array<GraphQL8::Field>] Field definitions for this node (there should only be one!)
      attr_reader :definitions

      # @return [GraphQL8::BaseType] The expected wrapped type this node must return.
