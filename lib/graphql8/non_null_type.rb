...
module GraphQL8
  class DoubleNonNullTypeError < GraphQL8::Error
  end
  ...
  #
  class NonNullType < GraphQL8::BaseType
    include GraphQL8::BaseType::ModifiesAnotherType
    extend Forwardable

    attr_reader :of_type
    def initialize(of_type:)
      if of_type.is_a?(GraphQL8::NonNullType)
        raise(
