...
require "graphql8/schema/base_64_encoder"
require "graphql8/schema/catchall_middleware"
require "graphql8/schema/default_parse_error"
require "graphql8/schema/default_type_error"
require "graphql8/schema/finder"
require "graphql8/schema/invalid_type_error"
require "graphql8/schema/introspection_system"
require "graphql8/schema/late_bound_type"
require "graphql8/schema/middleware_chain"
require "graphql8/schema/null_mask"
require "graphql8/schema/possible_types"
require "graphql8/schema/rescue_middleware"
require "graphql8/schema/timeout_middleware"
require "graphql8/schema/traversal"
require "graphql8/schema/type_expression"
require "graphql8/schema/unique_within_type"
require "graphql8/schema/validation"
require "graphql8/schema/warden"
require "graphql8/schema/build_from_definition"


require "graphql8/schema/member"
require "graphql8/schema/wrapper"
require "graphql8/schema/list"
require "graphql8/schema/non_null"
require "graphql8/schema/argument"
require "graphql8/schema/enum_value"
require "graphql8/schema/enum"
require "graphql8/schema/field"
require "graphql8/schema/input_object"
require "graphql8/schema/interface"
require "graphql8/schema/resolver"
require "graphql8/schema/mutation"
require "graphql8/schema/relay_classic_mutation"
require "graphql8/schema/object"
require "graphql8/schema/scalar"
require "graphql8/schema/union"

module GraphQL8
  # A GraphQL8 schema which may be queried with {GraphQL8::Query}.
  #
  # The {Schema} contains:
  #
  ...
  class Schema
    ...
    include GraphQL8::Define::InstanceDefinable
    accepts_definitions \
    ...
    # @see {GraphQL8::Query::Context} The parent class of these classes
    ...
    def default_filter
      GraphQL8::Filter.new(except: default_mask)
    end
    ...
    self.default_execution_strategy = GraphQL8::Execution::Execute

    DIRECTIVES = [GraphQL8::Directive::IncludeDirective, GraphQL8::Directive::SkipDirective, GraphQL8::Directive::DeprecatedDirective]
    ...
    def initialize
      ...
      @static_validator = GraphQL8::StaticValidation::Validator.new(schema: self)
      @middleware = MiddlewareChain.new(final_step: GraphQL8::Execution::Execute::FieldResolveStep)
      @query_analyzers = []
      @multiplex_analyzers = []
      ...
      @lazy_methods = GraphQL8::Execution::Lazy::LazyMethodMap.new
      @lazy_methods.set(GraphQL8::Execution::Lazy, :value)
      @cursor_encoder = Base64Encoder
      # Default to the built-in execution strategy:
      @query_execution_strategy = self.class.default_execution_strategy
      @mutation_execution_strategy = self.class.default_execution_strategy
      @subscription_execution_strategy = self.class.default_execution_strategy
      @default_mask = GraphQL8::Schema::NullMask
      @rebuilding_artifacts = false
      @context_class = GraphQL8::Query::Context
    ...
    def initialize_copy(other)
      ...
      @possible_types = GraphQL8::Schema::PossibleTypes.new(self)
    ...
    # @param string_or_document [String, GraphQL8::Language::Nodes::Document]
    # @return [Array<GraphQL8::StaticValidation::Message>]
    def validate(string_or_document, rules: nil)
      doc = if string_or_document.is_a?(String)
        GraphQL8.parse(string_or_document)
      else
        string_or_document
      end
      query = GraphQL8::Query.new(self, document: doc)
      validator_opts = { schema: self }
      rules && (validator_opts[:rules] = rules)
      validator = GraphQL8::StaticValidation::Validator.new(validator_opts)
    ...
    # @return [Array<GraphQL8::BaseType>] The root types of this schema
    def root_types
      @root_types ||= begin
        rebuild_artifacts
        @root_types
    ...
    # @see [GraphQL8::Schema::Warden] Restricted access to members of a schema
    # @return [GraphQL8::Schema::TypeMap] `{ name => type }` pairs of types in this schema
    def types
      @types ||= begin
        rebuild_artifacts
        @types
    ...
    # @param type [GraphQL8::ObjectType]
    # @return [Array<GraphQL8::UnionType>] list of union types of which the type is a member
    ...
    def multiplex(queries, **kwargs)
      with_definition_error_check {
        GraphQL8::Execution::Multiplex.run_all(self, queries, **kwargs)
      }
    end
    ...
    #
    # @see {GraphQL8::Schema::Finder} for more examples
    # @param path [String] A dot-separated path to the member
    # @raise [Schema::Finder::MemberNotFoundError] if path could not be found
    # @return [GraphQL8::BaseType, GraphQL8::Field, GraphQL8::Argument, GraphQL8::Directive] A GraphQL8 Schema Member
    def find(path)
    ...
    # @param parent_type [String, GraphQL8::BaseType]
    # @param field_name [String]
    # @return [GraphQL8::Field, nil] The field named `field_name` on `parent_type`
    # @see [GraphQL8::Schema::Warden] Restricted access to members of a schema
    ...
    # @return [Hash<String, GraphQL8::Field>]
    def get_fields(type)
      @instrumented_field_map[type.name]
    end

    def type_from_ast(ast_node)
      GraphQL8::Schema::TypeExpression.build_type(self.types, ast_node)
    end

    # @see [GraphQL8::Schema::Warden] Restricted access to members of a schema
    # @param type_defn [GraphQL8::InterfaceType, GraphQL8::UnionType] the type whose members you want to retrieve
    # @return [Array<GraphQL8::ObjectType>] types which belong to `type_defn` in this schema
    def possible_types(type_defn)
      @possible_types ||= GraphQL8::Schema::PossibleTypes.new(self)
      @possible_types.possible_types(type_defn)
    end

    # @see [GraphQL8::Schema::Warden] Resticted access to root types
    # @return [GraphQL8::ObjectType, nil]
    ...
    # Determine the GraphQL8 type for a given object.
    # This is required for unions and interfaces (including Relay's `Node` interface)
    # @see [GraphQL8::Schema::Warden] Restricted access to members of a schema
    # @param type [GraphQL8::UnionType, GraphQL8:InterfaceType] the abstract type which is being resolved
    # @param object [Any] An application object which GraphQL8 is currently resolving on
    # @param ctx [GraphQL8::Query::Context] The context for the current query
    # @return [GraphQL8::ObjectType] The type for exposing `object` in GraphQL8
    def resolve_type(type, object, ctx = :__undefined__)
      check_resolved_type(type, object, ctx) do |ok_type, ok_object, ok_ctx|
        if @resolve_type_proc.nil?
          raise(NotImplementedError, "Can't determine GraphQL8 type for: #{ok_object.inspect}, define `resolve_type (type, obj, ctx) -> { ... }` inside `Schema.define`.")
        end
    ...
    def check_resolved_type(type, object, ctx = :__undefined__)
      ...
      if object.is_a?(GraphQL8::Schema::Object)
      ...
      if type_result.nil?
        nil
      elsif !type_result.is_a?(GraphQL8::BaseType)
        type_str = "#{type_result} (#{type_result.class.name})"
        raise "resolve_type(#{object}) returned #{type_str}, but it should return a GraphQL8 type"
      else
        type_result
      end
    end
    ...
    def resolve_type=(new_resolve_type_proc)
      callable = GraphQL8::BackwardsCompatibility.wrap_arity(new_resolve_type_proc, from: 2, to: 3, last: true, name: "Schema#resolve_type(type, obj, ctx)")
      @resolve_type_proc = callable
    end

    # Fetch an application object by its unique id
    # @param id [String] A unique identifier, provided previously by this GraphQL8 schema
    # @param ctx [GraphQL8::Query::Context] The context for the current query
    ...
    # add a {GraphQL8::ExecutionError} to the response (with `ctx.add_error`)
    # or raise an exception and halt query execution.
    #
    # @example A `nil` is encountered by a non-null field
    #   type_error ->(err, query_ctx) {
    #     err.is_a?(GraphQL8::InvalidNullError) # => true
    #   }
    #
    # @example An object doesn't resolve to one of a {UnionType}'s members
    #   type_error ->(err, query_ctx) {
    #     err.is_a?(GraphQL8::UnresolvedTypeError) # => true
    #   }
    #
    # @see {DefaultTypeError} is the default behavior.
    # @param err [GraphQL8::TypeError] The error encountered during execution
    # @param ctx [GraphQL8::Query::Context] The context for the field where the error occurred
    # @return void
    ...
    # @param err [GraphQL8::ParseError] The error encountered during parsing
    # @param ctx [GraphQL8::Query::Context] The context for the query where the error occurred
    # @return void
    ...
    # @param type [GraphQL8::BaseType] The current type definition
    # @param ctx [GraphQL8::Query::Context] the context for the current query
    ...
    # @param introspection_result [Hash] A response from {GraphQL8::Introspection::INTROSPECTION_QUERY}
    # @return [GraphQL8::Schema] the schema described by `input`
    def self.from_introspection(introspection_result)
      GraphQL8::Schema::Loader.load(introspection_result)
    end
    ...
    # @return [GraphQL8::Schema] the schema described by `document`
    def self.from_definition(definition_or_path, default_resolve: BuildFromDefinition::DefaultResolve, parser: BuildFromDefinition::DefaultParser)
      ...
      GraphQL8::Schema::BuildFromDefinition.from_definition(definition, default_resolve: default_resolve, parser: parser)
    end
    ...
    # Return the GraphQL8 IDL for the schema
    # @param context [Hash]
    # @param only [<#call(member, ctx)>]
    # @param except [<#call(member, ctx)>]
    # @return [String]
    def to_definition(only: nil, except: nil, context: {})
      GraphQL8::Schema::Printer.print_schema(self, only: only, except: except, context: context)
    end

    # Return the GraphQL8::Language::Document IDL AST for the schema
    # @return [GraphQL8::Language::Document]
    def to_document
      GraphQL8::Language::DocumentFromSchemaDefinition.new(self).document
    end
    ...
    class << self
      ...
      def to_graphql
        ...
        schema_defn.query_analyzers << GraphQL8::Authorization::Analyzer
        ...
        schema_defn.instrumenters[:query] << GraphQL8::Schema::Member::Instrumentation
      ...
      #
      # If you want to add an error to the `"errors"` key, raise a {GraphQL8::ExecutionError}
      # in this hook.
      #
      # @param unauthorized_error [GraphQL8::UnauthorizedError]
      # @return [Object] The returned object will be put in the GraphQL8 response
    ...
    def after_lazy(value)
      if lazy?(value)
        GraphQL8::Execution::Lazy.new do
    ...
    # @param ctx [GraphQL8::Query::Context] the context for this query
    # @return [Object] A GraphQL8-ready (non-lazy) object
    ...
    def rescue_middleware
      @rescue_middleware ||= GraphQL8::Schema::RescueMiddleware.new.tap { |m| middleware.insert(0, m) }
    end
    ...
    class CyclicalDefinitionError < GraphQL8::Error
    end
