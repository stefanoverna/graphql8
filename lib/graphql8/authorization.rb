...
module GraphQL8
  module Authorization
    class InaccessibleFieldsError < GraphQL8::AnalysisError
      # @return [Array<Schema::Field, GraphQL8::Field>] Fields that failed `.accessible?` checks
      attr_reader :fields

      # @return [GraphQL8::Query::Context] The current query's context
      attr_reader :context

      # @return [Array<GraphQL8::InternalRepresentation::Node>] The visited nodes that failed `.accessible?` checks
