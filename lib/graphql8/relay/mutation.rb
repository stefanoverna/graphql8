...
require "graphql8/relay/mutation/instrumentation"
require "graphql8/relay/mutation/resolve"
require "graphql8/relay/mutation/result"
...
module GraphQL8
  module Relay
    ...
    #   UpdateNameMutation = GraphQL8::Relay::Mutation.define do
    #     name "UpdateName"
    #
    ...
    #     }|
    #
    #    GraphQL8::Query.new(MySchema, query_string).result
    #    # {"data" => {
    #    #   "updateName" => {
    #    #     "item" => { "name" => "new name"},
    ...
    #    # }}
    #
    # @example Using a GraphQL8::Function
    #   class UpdateAttributes < GraphQL8::Function
    ...
    #         arg_name = name.to_s
    #         @arguments[arg_name] = GraphQL8::Argument.define(name: arg_name, type: type)
    #       end
    #       @arguments["id"] = GraphQL8::Argument.define(name: "id", type: !GraphQL8::ID_TYPE)
    #       @return_as = return_as
    ...
    class Mutation
      ...
      accepts_definitions(
        ...
        return_field: GraphQL8::Define::AssignObjectField,
        function: GraphQL8::Define::AssignMutationFunction,
      )
      ...
      def input_type
        @input_type ||= begin
          relay_mutation = self
          input_object_type = GraphQL8::InputObjectType.define do
