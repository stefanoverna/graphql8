...
module GraphQL8
  module Relay
    # This provides some isolation from `GraphQL8::Relay` internals.
    #
    ...
    class RangeAdd
      ...
      # @param context [GraphQL8::Query::Context] The surrounding `ctx`, will be passed to the connection if provided (this is required for cursor encoders)
