...
module GraphQL8
  module Relay
    ...
    class BaseConnection
      ...
      # @param arguments [GraphQL8::Query::Arguments] Query arguments
      # @param field [GraphQL8::Field] The underlying field
      # @param max_page_size [Int] The maximum number of results to return
      # @param parent [Object] The object which this collection belongs to
      # @param context [GraphQL8::Query::Context] The context from the field being resolved
      def initialize(nodes, arguments, field: nil, max_page_size: nil, parent: nil, context: nil)
        ...
        @field = field
        @parent = parent
        @encoder = context ? @context.schema.cursor_encoder : GraphQL8::Schema::Base64Encoder
      ...
      def decode(data)
        ...
        raise GraphQL8::ExecutionError, "Invalid cursor: #{data.inspect}"
      end
      ...
      # probably wrapped by {GraphQL8::Relay::Edge}
      def edge_nodes
      ...
      def inspect
        "#<GraphQL8::Relay::Connection @parent=#{@parent.inspect} @arguments=#{@arguments.to_h.inspect}>"
      end
