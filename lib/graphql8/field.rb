...
require "graphql8/field/resolve"
...
module GraphQL8
  ...
  # This block is equivalent to calling `GraphQL8::Field.define { ... }`.
  #
  ...
  #   name_field = GraphQL8::Field.define do
  #     name("Name")
  #     type(!types.String)
  ...
  #   end
  #
  #   NamedType = GraphQL8::ObjectType.define do
  #     # The second argument may be a GraphQL8::Field
  ...
  class Field
    ...
    # @return [String] The name of this field on its {GraphQL8::ObjectType} (or {GraphQL8::InterfaceType})
    attr_reader :name
    ...
    # @return [Object, GraphQL8::Function] The function used to derive this field
    ...
    # @param args [GraphQL8::Query::Arguments] Arguments to this field
    # @param ctx [GraphQL8::Query::Context] Context for this field
    ...
    # @return [GraphQL8::Execution::Lazy] A lazy wrapper around `obj` and its registered method name
    def prepare_lazy(obj, args, ctx)
      GraphQL8::Execution::Lazy.new {
    ...
    def build_default_resolver
      GraphQL8::Field::Resolve.create_proc(self)
    end
