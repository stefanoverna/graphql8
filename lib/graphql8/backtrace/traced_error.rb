...
module GraphQL8
  class Backtrace
    ...
    class TracedError < GraphQL8::Error
      # @return [Array<String>] Printable backtrace of GraphQL8 error context
      attr_reader :graphql_backtrace

      # @return [GraphQL8::Query::Context] The context at the field where the error was raised
      attr_reader :context
