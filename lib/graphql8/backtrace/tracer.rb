...
module GraphQL8
  class Backtrace
    module Tracer
      ...
      # Implement the {GraphQL8::Tracing} API.
      def trace(key, metadata)
        ...
        if key == "execute_multiplex"
          begin
            ...
            # Re-raise it with a GraphQL8 trace.
            potential_context = Thread.current[:last_graphql_backtrace_context]

            if potential_context.is_a?(GraphQL8::Query::Context) || potential_context.is_a?(GraphQL8::Query::Context::FieldResolutionContext)
