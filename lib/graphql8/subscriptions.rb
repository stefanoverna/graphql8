...
require "graphql8/subscriptions/event"
require "graphql8/subscriptions/instrumentation"
require "graphql8/subscriptions/serialize"
if defined?(ActionCable)
  require "graphql8/subscriptions/action_cable_subscriptions"
end
...
module GraphQL8
  class Subscriptions
    ...
    class InvalidTriggerError < GraphQL8::Error
    end
    ...
    # @param schema [Class] the GraphQL8 schema this manager belongs to
    ...
    #
    # Load `subscription_id`'s GraphQL8 data, re-evaluate the query, and deliver the result.
    #
    # This is where a queue may be inserted to push updates in the background.
    #
    # @param subscription_id [String]
    # @param event [GraphQL8::Subscriptions::Event] The event which was triggered
    ...
    # @param event [GraphQL8::Subscriptions::Event]
    ...
    # @param events [Array<GraphQL8::Subscriptions::Event>]
    # @return [void]
    ...
    # @param arg_owner [GraphQL8::Field, GraphQL8::BaseType]
    # @param args [Hash, Array, Any] some GraphQL8 input value to coerce as `arg_owner`
    # @return [Any] normalized arguments value
    def normalize_arguments(event_name, arg_owner, args)
      case arg_owner
      when GraphQL8::Field, GraphQL8::InputObjectType
        normalized_args = {}
        missing_arg_names = []
        args.each do |k, v|
          arg_name = k.to_s
        ...
        if missing_arg_names.any?
          arg_owner_name = if arg_owner.is_a?(GraphQL8::Field)
