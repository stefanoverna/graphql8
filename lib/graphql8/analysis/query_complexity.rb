...
module GraphQL8
  module Analysis
    ...
    #   MySchema.query_analyzers << GraphQL8::Analysis::QueryComplexity.new do |query, complexity|
    ...
    class QueryComplexity
      ...
      # @yieldparam query [GraphQL8::Query] The query that was analyzed
      ...
      # @return [Object, GraphQL8::AnalysisError] Whatever the handler returns
