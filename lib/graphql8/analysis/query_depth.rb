...
module GraphQL8
  module Analysis
    ...
    #   Schema.query_analyzers << GraphQL8::Analysis::QueryDepth.new { |query, depth|  puts "GraphQL8 query depth: #{depth}" }
    #   Schema.execute(query_str)
    #   # GraphQL8 query depth: 8
    #
    class QueryDepth
      ...
      def call(memo, visit_type, irep_node)
        if irep_node.ast_node.is_a?(GraphQL8::Language::Nodes::Field)
          ...
          not_validated_node = GraphQL8::Schema::DYNAMIC_FIELDS.include?(irep_node.definition_name)
          if visit_type == :enter
