...
module GraphQL8
  ...
  #   LanguageEnum = GraphQL8::EnumType.define do
  #     name "Language"
  ...
  class EnumType < GraphQL8::BaseType
    accepts_definitions :values, value: GraphQL8::Define::AssignEnumValue
    ...
    class EnumValue
      ...
      def name=(new_name)
        ...
        GraphQL8::NameValidator.validate!(new_name)
        @name = new_name
      end
    ...
    class UnresolvedValueError < GraphQL8::Error
    end
    ...
    def coerce_non_null_input(value_name, ctx)
      if @values_by_name.key?(value_name)
        ...
        # the Ruby value, not the GraphQL8 string.
    ...
    def validate_non_null_input(value_name, ctx)
      ...
      if matching_value.nil?
        result.add_problem("Expected #{GraphQL8::Language.serialize(value_name)} to be one of: #{allowed_values.map(&:name).join(', ')}")
      end
