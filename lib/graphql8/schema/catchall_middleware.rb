...
module GraphQL8
  class Schema
    # In early GraphQL8 versions, errors would be "automatically"
    ...
    # - The entry in {Query::Context#errors} is a {GraphQL8::ExecutionError}, _not_
