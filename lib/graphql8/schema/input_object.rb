...
module GraphQL8
  class Schema
    class InputObject < GraphQL8::Schema::Member
      ...
      # @return [GraphQL8::Query::Context] The context for this query
      attr_reader :context

      # @return [GraphQL8::Query::Arguments] The underlying arguments instance
      ...
      class << self
        # @return [Class<GraphQL8::Arguments>]
        ...
        def to_graphql
          type_defn = GraphQL8::InputObjectType.new
          ...
          self.arguments_class = GraphQL8::Query::Arguments.construct_arguments_class(type_defn)
