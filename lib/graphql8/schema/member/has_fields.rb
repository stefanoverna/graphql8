  ...
  class Schema
    class Member
      ...
      module HasFields
        ...
        # @see {GraphQL8::Schema::Field#initialize} for method signature
        # @return [void]
        ...
        # @return [Hash<String => GraphQL8::Schema::Field>] Fields on this object, keyed by name, including inherited fields
        def fields
        ...
        # @param field_defn [GraphQL8::Schema::Field]
        # @return [void]
        ...
        def field_class(new_field_class = nil)
          if new_field_class
            ...
            superclass.respond_to?(:field_class) ? superclass.field_class : GraphQL8::Schema::Field
          else
            ancestor = ancestors[1..-1].find { |a| a.respond_to?(:field_class) && a.field_class }
            ancestor ? ancestor.field_class : GraphQL8::Schema::Field
          end
        end

        def global_id_field(field_name)
          field field_name, "ID", null: false, resolve: GraphQL8::Relay::GlobalIdResolve.new(type: self)
        end

        # @return [Array<GraphQL8::Schema::Field>] Fields defined on this class _specifically_, not parent classes
        def own_fields
          @own_fields ||= {}
        end
