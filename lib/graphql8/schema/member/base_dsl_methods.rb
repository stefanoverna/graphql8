...
module GraphQL8
  class Schema
    class Member
      # DSL methods shared by lots of things in the GraphQL8 Schema.
      # @api private
      # @see Classes that extend this, eg {GraphQL8::Schema::Object}
      module BaseDSLMethods
        ...
        # @return [GraphQL8::BaseType] Convert this type to a legacy-style object.
        def to_graphql
