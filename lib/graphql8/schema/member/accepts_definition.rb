...
module GraphQL8
  class Schema
    class Member
      ...
      # Eventually, `GraphQL8::{X}Type` objects will be removed entirely,
      ...
      #   GraphQL8::ObjectType.accepts_definition({
      ...
      module AcceptsDefinition
        def self.included(child)
          ...
          child.prepend(ToGraphQL8Extension)
        ...
        def self.extended(child)
          if defined?(child::DefinitionMethods)
            ...
            child::DefinitionMethods.prepend(ToGraphQL8Extension)
          else
            child.extend(AcceptsDefinitionDefinitionMethods)
