...
module GraphQL8
  class Schema
    ...
    #
    # @see {GraphQL8::Schema::RelayClassicMutation} for an extension of this class with some conventions built-in.
    #
    # @example Creating a comment
    #  # Define the mutation:
    #  class Mutations::CreateComment < GraphQL8::Schema::Mutation
    ...
    #  class Types::Mutation < GraphQL8::Schema::Object
    #    field :create_comment, mutation: Mutations::CreateComment
    #  end
    #
    #  # Call it from GraphQL8:
    ...
    #  GRAPHQL
    #
    class Mutation < GraphQL8::Schema::Resolver
      ...
      class << self
        ...
        def field_class(new_class = nil)
          if new_class
            ...
            @field_class || find_inherited_method(:field_class, GraphQL8::Schema::Field)
          end
        end

        # An object class to use for deriving return types
        # @param new_class [Class, nil] Defaults to {GraphQL8::Schema::Object}
        # @return [Class]
        def object_class(new_class = nil)
          if new_class
            @object_class = new_class
          end
          @object_class || (superclass.respond_to?(:object_class) ? superclass.object_class : GraphQL8::Schema::Object)
        end
