...
module GraphQL8
  class Schema
    class Field
      ...
      include GraphQL8::Schema::Member::HasArguments
      include GraphQL8::Schema::Member::HasPath

      # @return [String] the GraphQL8 name for this field, camelized unless `camelize: false` is provided
      attr_reader :name
      ...
      # @param resolver [Class] A {GraphQL8::Schema::Resolver} class to use for field configuration
      # @param mutation [Class] A {GraphQL8::Schema::Mutation} class to use for field configuration
      # @return [GraphQL8::Schema:Field] an instance of `self
      ...
      def self.from_options(name = nil, type = nil, desc = nil, resolver: nil, mutation: nil, **kwargs, &block)
        ...
        if !type.nil?
          if type.is_a?(GraphQL8::Field)
            raise ArgumentError, "A GraphQL8::Field was passed as the second argument, use the `field:` keyword for this instead."
          end
          if desc
      ...
      # @param name [Symbol] The underscore-cased version of this field name (will be camelized for the GraphQL8 API)
      # @param return_type_expr [Class, GraphQL8::BaseType, Array] The return type of this field
      ...
      # @param field [GraphQL8::Field, GraphQL8::Schema::Field] **deprecated** for compatibility with <1.8.0
      # @param function [GraphQL8::Function] **deprecated** for compatibility with <1.8.0
      # @param resolver_class [Class] (Private) A {Schema::Resolver} which this field was derived from. Use `resolver:` to create a field with a resolver.
      # @param arguments [{String=>GraphQL8::Schema::Argument, Hash}] Arguments for this field (may be added in the block, also)
      ...
      def initialize(type: nil, name: nil, owner: nil, null: nil, field: nil, function: nil, description: nil, deprecation_reason: nil, method: nil, connection: nil, max_page_size: nil, scope: nil, resolve: nil, introspection: false, hash_key: nil, camelize: true, trace: nil, complexity: 1, extras: [], resolver_class: nil, subscription_scope: nil, arguments: {}, &definition_block)
        ...
        if field.is_a?(GraphQL8::Schema::Field)
      ...
      def to_graphql
        ...
        field_defn = if @field
          ...
          GraphQL8::Function.build_field(@function)
        else
          GraphQL8::Field.new
        end
        ...
        if @resolver_class
          if @resolver_class < GraphQL8::Schema::Mutation
      ...
      # Implement {GraphQL8::Field}'s resolve API.
      #
      ...
      # @param obj [GraphQL8::Schema::Object]
      # @param ruby_kwargs [Hash<Symbol => Object>]
      # @param ctx [GraphQL8::Query::Context]
      ...
      # @param ctx [GraphQL8::Query::Context::FieldResolutionContext]
      ...
      def public_send_field(obj, graphql_args, field_ctx)
        if graphql_args.any? || @extras.any?
          # Splat the GraphQL8::Arguments to Ruby keyword arguments
