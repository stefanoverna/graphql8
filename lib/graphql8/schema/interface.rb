...
module GraphQL8
  class Schema
    module Interface
      include GraphQL8::Schema::Member::GraphQL8TypeNames
      module DefinitionMethods
        include GraphQL8::Schema::Member::CachedGraphQL8Definition
        include GraphQL8::Relay::TypeExtensions
        include GraphQL8::Schema::Member::BaseDSLMethods
        include GraphQL8::Schema::Member::TypeSystemHelpers
        include GraphQL8::Schema::Member::HasFields
        include GraphQL8::Schema::Member::HasPath
        include GraphQL8::Schema::Member::RelayShortcuts
        include GraphQL8::Schema::Member::Scoped
        ...
        def included(child_class)
          ...
          elsif child_class < GraphQL8::Schema::Object
        ...
        def to_graphql
          type_defn = GraphQL8::InterfaceType.new
