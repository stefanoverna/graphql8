...
require "graphql8/schema/build_from_definition/resolve_map"
...
module GraphQL8
  class Schema
    module BuildFromDefinition
      ...
      # @api private
      DefaultParser = GraphQL8::Language::Parser
      ...
      module Builder
        ...
        def build(document, default_resolve: DefaultResolve)
          raise InvalidDocumentError.new('Must provide a document ast.') if !document || !document.is_a?(GraphQL8::Language::Nodes::Document)
        ...
        def build_deprecation_reason(directives)
          ...
          return GraphQL8::Directive::DEFAULT_DEPRECATION_REASON unless reason

          reason.value
        end

        def build_scalar_type(scalar_type_definition, type_resolver, default_resolve:)
          scalar_type = GraphQL8::ScalarType.define(
        ...
        def build_union_type(union_type_definition, type_resolver)
          union = GraphQL8::UnionType.define(
        ...
        def build_object_type(object_type_definition, type_resolver, default_resolve:)
          ...
          type_def = GraphQL8::ObjectType.define(
        ...
        def build_input_object_type(input_object_type_definition, type_resolver)
          input = GraphQL8::InputObjectType.define(
        ...
        def build_default_value(default_value)
          ...
          when GraphQL8::Language::Nodes::Enum
            default_value.name
          when GraphQL8::Language::Nodes::NullValue
            nil
        ...
        def build_input_arguments(input_object_type_definition, type_resolver)
          input_object_type_definition.fields.map do |input_argument|
            ...
            argument = GraphQL8::Argument.define(
        ...
        def build_directive(directive_definition, type_resolver)
          directive = GraphQL8::Directive.define(
        ...
        def build_interface_type(interface_type_definition, type_resolver)
          interface = GraphQL8::InterfaceType.define(
        ...
        def resolve_type(types, ast_node)
          type = GraphQL8::Schema::TypeExpression.build_type(types, ast_node)
          if type.nil?
