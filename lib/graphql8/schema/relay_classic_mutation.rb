...
module GraphQL8
  class Schema
    ...
    #   using one GraphQL8 variable (`$input`) instead of making a separate variable for each argument.
    #
    # @see {GraphQL8::Schema::Mutation} for an example, it's basically the same.
    #
    class RelayClassicMutation < GraphQL8::Schema::Mutation
      # The payload should always include this field
      field(:client_mutation_id, String, "A unique identifier for the client performing the mutation.", null: true)
      # Relay classic default:
      null(true)

      # Override {GraphQL8::Schema::Resolver#resolve_with_support} to
      ...
      class << self
        ...
        # @return [Class] The base class for this mutation's generated input object (default is {GraphQL8::Schema::InputObject})
        def input_object_class(new_class = nil)
          if new_class
            @input_object_class = new_class
          end
          @input_object_class || (superclass.respond_to?(:input_object_class) ? superclass.input_object_class : GraphQL8::Schema::InputObject)
        end
