...
module GraphQL8
  module Types
    module Relay
      ...
      # so you can extend your own `BaseObject` instead of `GraphQL8::Schema::Object`.
      #
      ...
      #   class Types::BaseEdge < GraphQL8::Types::Relay::BaseEdge; end
      #   class Types::BaseConnection < GraphQL8::Types::Relay::BaseConnection; end
      #
      ...
      class BaseConnection < Types::Relay::BaseObject
        ...
        class << self
          ...
          def edge_type(edge_type_class, edge_class: GraphQL8::Relay::Edge, node_type: edge_type_class.node_type, nodes_field: true)
        ...
        field :page_info, GraphQL8::Types::Relay::PageInfo, null: false, description: "Information to aid in pagination."
