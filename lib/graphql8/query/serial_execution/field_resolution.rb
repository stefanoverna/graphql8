    ...
    class SerialExecution
      class FieldResolution
        ...
        def result
          ...
          if raw_value.is_a?(GraphQL8::Execution::Execute::Skip)
            {}
          else
        ...
        # GraphQL8::Batch depends on this
        ...
        def get_finished_value(raw_value)
          ...
          begin
            GraphQL8::Query::SerialExecution::ValueResolution.resolve(
              parent_type,
              field,
              field.type,
              raw_value,
          ...
          rescue GraphQL8::Query::Executor::PropagateNull
        ...
        # If the middleware chain returns a GraphQL8::ExecutionError, its message
