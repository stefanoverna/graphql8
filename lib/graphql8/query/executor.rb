...
module GraphQL8
  class Query
    class Executor
      ...
      # @return [GraphQL8::Query] the query being executed
      attr_reader :query
      ...
      # Handle {GraphQL8::ExecutionError}s by putting them in the "errors" key.
      # @return [Hash] A GraphQL8 response, with either a "data" key or an "errors" key
      def result
        execute
