...
module GraphQL8
  ...
  class Directive
    ...
    accepts_definitions :locations, :name, :description, :arguments, :default_directive, argument: GraphQL8::Define::AssignArgument
...
require "graphql8/directive/include_directive"
require "graphql8/directive/skip_directive"
require "graphql8/directive/deprecated_directive"
