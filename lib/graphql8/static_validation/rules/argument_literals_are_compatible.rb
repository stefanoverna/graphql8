...
module GraphQL8
  module StaticValidation
    class ArgumentLiteralsAreCompatible < GraphQL8::StaticValidation::ArgumentsValidator
      def validate_node(parent, node, defn, context)
        return if node.value.is_a?(GraphQL8::Language::Nodes::VariableIdentifier)
        ...
        begin
        ...
        rescue GraphQL8::LiteralValidationError => err
          ...
          elsif arg_defn.type.kind.input_object? && node.value.is_a?(GraphQL8::Language::Nodes::InputObject)
