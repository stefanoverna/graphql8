...
module GraphQL8
  module StaticValidation
    class RequiredInputObjectAttributesArePresent
      ...
      include GraphQL8::StaticValidation::ArgumentsValidator::ArgumentsValidatorHelpers

      def validate(context)
        visitor = context.visitor
        visitor[GraphQL8::Language::Nodes::InputObject] << ->(node, parent) {
          next unless parent.is_a? GraphQL8::Language::Nodes::Argument
