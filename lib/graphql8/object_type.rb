...
module GraphQL8
  ...
  #   MovieType = GraphQL8::ObjectType.define do
  #     name "Movie"
  ...
  #   end
  #
  class ObjectType < GraphQL8::BaseType
    accepts_definitions :interfaces, :fields, :mutation, :relay_node_type, field: GraphQL8::Define::AssignObjectField
    ...
    # @!attribute fields
    #   @return [Hash<String => GraphQL8::Field>] Map String fieldnames to their {GraphQL8::Field} implementations

    # @!attribute mutation
    #   @return [GraphQL8::Relay::Mutation, nil] The mutation this object type was derived from, if it is an auto-generated payload type.
    ...
    # @param new_interfaces [Array<GraphQL8::Interface>] interfaces that this type implements
    ...
    # @return [GraphQL8::Field] The field definition for `field_name` (may be inherited from interfaces)
    ...
    # @return [Array<GraphQL8::Field>] All fields, including ones inherited from interfaces
    def all_fields
    ...
    # @param interfaces [Array<GraphQL8::Interface>] add a new interface that this type implements
    ...
    def normalize_interfaces(ifaces)
      ifaces.map { |i_type| GraphQL8::BaseType.resolve_related_type(i_type) }
    end
    ...
    def load_interfaces
      @clean_interfaces ||= begin
        ...
        clean_inherited_ifaces.each do |iface|
          ...
          if iface.is_a?(GraphQL8::InterfaceType)
