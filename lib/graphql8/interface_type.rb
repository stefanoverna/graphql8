...
module GraphQL8
  ...
  #   DeviceInterface = GraphQL8::InterfaceType.define do
  #     name("Device")
  ...
  #   Laptoptype = GraphQL8::ObjectType.define do
  #     interfaces [DeviceInterface]
  #   end
  #
  class InterfaceType < GraphQL8::BaseType
    accepts_definitions :fields, :orphan_types, :resolve_type, field: GraphQL8::Define::AssignObjectField
    ...
    # @return [GraphQL8::Field] The defined field for `field_name`
    ...
    # @return [Array<GraphQL8::Field>] All fields on this type
    def all_fields
      fields.values
    end
    ...
    # @return [GraphQL8::ObjectType, nil] The type named `type_name` if it exists and implements this {InterfaceType}, (else `nil`)
    ...
    # @param type [String, GraphQL8::BaseType] Name of the type or a type definition
    # @param ctx [GraphQL8::Query::Context] The context for the current query
