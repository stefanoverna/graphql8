...
require "graphql8/compatibility/execution_specification/counter_schema"
require "graphql8/compatibility/execution_specification/specification_schema"
...
module GraphQL8
  module Compatibility
    ...
    # - Directive support
    # - Typecasting
    # - Error handling (raise / return GraphQL8::ExecutionError)
      ...
      def self.build_suite(execution_strategy)
        Class.new(Minitest::Test) do
          ...
          def test_it_applies_masking
            ...
            err = assert_raises(GraphQL8::UnresolvedTypeError) {
            ...
            assert_equal GraphQL8::Relay::Node.interface, err.field.type
          ...
          def test_it_runs_the_introspection_query
            execute_query(GraphQL8::Introspection::INTROSPECTION_QUERY)
          end
