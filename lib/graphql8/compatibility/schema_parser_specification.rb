...
module GraphQL8
  module Compatibility
    ...
    # the proper tree of {{GraphQL8::Language::Nodes}}.
    module SchemaParserSpecification
      # @yieldparam query_string [String] A query string to parse
      # @yieldreturn [GraphQL8::Language::Nodes::Document]
      ...
      def self.build_suite(&block)
        Class.new(Minitest::Test) do
          ...
          def test_it_parses_object_types
            ...
            assert_equal GraphQL8::Language::Nodes::ObjectTypeDefinition, type.class
          ...
          def test_it_parses_scalars
            ...
            type = document.definitions.first
            assert_equal GraphQL8::Language::Nodes::ScalarTypeDefinition, type.class
          ...
          def test_it_parses_enum_types
            ...
            type = document.definitions.first
            assert_equal GraphQL8::Language::Nodes::EnumTypeDefinition, type.class
          ...
          def test_it_parses_union_types
            ...
            assert_equal GraphQL8::Language::Nodes::UnionTypeDefinition, union.class
            assert_equal 'BagOfThings', union.name
            assert_equal 3, union.types.length
            assert_equal [1, 1], union.position

            assert_equal GraphQL8::Language::Nodes::TypeName, union.types[0].class
            assert_equal 'A', union.types[0].name
            assert_equal [2, 1], union.types[0].position

            assert_equal GraphQL8::Language::Nodes::TypeName, union.types[1].class
            assert_equal 'B', union.types[1].name
            assert_equal [3, 1], union.types[1].position

            assert_equal GraphQL8::Language::Nodes::TypeName, union.types[2].class
          ...
          def test_it_parses_input_types
            ...
            type = document.definitions.first
            assert_equal GraphQL8::Language::Nodes::InputObjectTypeDefinition, type.class
          ...
          def test_it_parses_directives
            ...
            type = document.definitions.first
            assert_equal GraphQL8::Language::Nodes::DirectiveDefinition, type.class
            ...
            assert_instance_of GraphQL8::Language::Nodes::DirectiveLocation, type.locations[0]
            assert_equal 'FIELD', type.locations[0].name
            assert_equal [3, 20], type.locations[0].position

            assert_instance_of GraphQL8::Language::Nodes::DirectiveLocation, type.locations[1]
            assert_equal 'FRAGMENT_SPREAD', type.locations[1].name
            assert_equal [4, 19], type.locations[1].position

            assert_instance_of GraphQL8::Language::Nodes::DirectiveLocation, type.locations[2]
          ...
          def test_it_parses_schema_extensions
            ...
            assert_equal GraphQL8::Language::Nodes::SchemaExtension, schema_extension.class
          ...
          def test_it_parses_schema_extensions_with_directives
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, schema_extension.directives.first.class
          ...
          def test_it_parses_scalar_extensions
            ...
            assert_equal GraphQL8::Language::Nodes::ScalarTypeExtension, scalar_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, scalar_extension.directives.first.class
            assert_equal 'something', scalar_extension.directives.first.name
            assert_equal GraphQL8::Language::Nodes::Directive, scalar_extension.directives.last.class
          ...
          def test_it_parses_object_type_extensions_with_field_definitions
            ...
            assert_equal GraphQL8::Language::Nodes::ObjectTypeExtension, object_type_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::FieldDefinition, object_type_extension.fields.first.class
          end
          ...
          def test_it_parses_object_type_extensions_with_field_definitions_and_directives
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, object_type_extension.directives.first.class
          end
          ...
          def test_it_parses_object_type_extensions_with_field_definitions_and_implements
            ...
            assert_equal GraphQL8::Language::Nodes::TypeName, object_type_extension.interfaces.first.class
          end
          ...
          def test_it_parses_interface_type_extensions_with_directives_and_fields
            ...
            assert_equal GraphQL8::Language::Nodes::InterfaceTypeExtension, interface_type_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, interface_type_extension.directives.first.class
            ...
            assert_equal GraphQL8::Language::Nodes::FieldDefinition, interface_type_extension.fields.first.class
          ...
          def test_it_parses_union_type_extension_with_union_members
            ...
            assert_equal GraphQL8::Language::Nodes::UnionTypeExtension, union_type_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::TypeName, union_type_extension.types.first.class
          ...
          def test_it_parses_union_type_extension_with_directives_and_union_members
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, union_type_extension.directives.first.class
          ...
          def test_it_parses_enum_type_extension_with_values
            ...
            assert_equal GraphQL8::Language::Nodes::EnumTypeExtension, enum_type_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::EnumValueDefinition, enum_type_extension.values.first.class
          ...
          def test_it_parses_enum_type_extension_with_directives_and_values
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, enum_type_extension.directives.first.class
          ...
          def test_it_parses_input_object_type_extension_with_fields
            ...
            assert_equal GraphQL8::Language::Nodes::InputObjectTypeExtension, input_object_type_extension.class
            ...
            assert_equal GraphQL8::Language::Nodes::InputValueDefinition, input_object_type_extension.fields.first.class
          ...
          def test_it_parses_input_object_type_extension_with_directives_and_fields
            ...
            assert_equal GraphQL8::Language::Nodes::Directive, input_object_type_extension.directives.first.class
          ...
          def test_it_parses_whole_definition_with_descriptions
            ...
            assert_equal GraphQL8::Language::Nodes::SchemaDefinition, schema_definition.class

            directive_definition = document.definitions.shift
            assert_equal GraphQL8::Language::Nodes::DirectiveDefinition, directive_definition.class
            assert_equal 'This is a directive', directive_definition.description

            enum_type_definition = document.definitions.shift
            assert_equal GraphQL8::Language::Nodes::EnumTypeDefinition, enum_type_definition.class
            ...
            assert_equal GraphQL8::Language::Nodes::ObjectTypeDefinition, object_type_definition.class
            ...
            assert_equal GraphQL8::Language::Nodes::InputObjectTypeDefinition, input_object_type_definition.class
            ...
            assert_equal GraphQL8::Language::Nodes::InterfaceTypeDefinition, interface_type_definition.class
            ...
            assert_instance_of GraphQL8::Language::Nodes::NullValue, brand_field.arguments[0].default_value
          end
        end
      end
