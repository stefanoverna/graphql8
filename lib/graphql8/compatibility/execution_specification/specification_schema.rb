    ...
    module ExecutionSpecification
      module SpecificationSchema
        ...
        def self.build(execution_strategy)
          ...
          timestamp_type = GraphQL8::ScalarType.define do
            name "Timestamp"
            coerce_input ->(value, _ctx) { Time.at(value.to_i) }
            coerce_result ->(value, _ctx) { value.to_i }
          end

          named_entity_interface_type = GraphQL8::InterfaceType.define do
            name "NamedEntity"
            field :name, !types.String
          end

          person_type = GraphQL8::ObjectType.define do
            name "Person"
          ...
          organization_type = GraphQL8::ObjectType.define do
            name "Organization"
            interfaces [named_entity_interface_type]
            field :name, !types.String
            ...
            field :returnedError, types.String do
              resolve ->(o, a, c) {
                GraphQL8::ExecutionError.new("This error was returned")
              }
            end
            field :raisedError, types.String do
              resolve ->(o, a, c) {
                raise GraphQL8::ExecutionError.new("This error was raised")
              }
            end
            ...
            field :nodePresence, !types[!types.Boolean] do
              resolve ->(o, a, ctx) {
                [
                  ctx.irep_node.is_a?(GraphQL8::InternalRepresentation::Node),
                  ctx.ast_node.is_a?(GraphQL8::Language::Nodes::AbstractNode),
                  false, # just testing
                ]
              }
            end
          ...
          node_union_type = GraphQL8::UnionType.define do
            name "Node"
          ...
          GraphQL8::Schema.define do
            ...
            type_error ->(err, ctx) {
              ...
              ctx[:gobble] || GraphQL8::Schema::DefaultTypeError.call(err, ctx)
            }
