...
module GraphQL8
  module Language
    module Nodes
      # {AbstractNode} is the base class for all nodes in a GraphQL8 AST.
      #
      # It provides some APIs for working with ASTs:
      # - `children` returns all AST nodes attached to this one. Used for tree traversal.
      # - `scalars` returns all scalar (Ruby) values attached to this one. Used for comparing nodes.
      # - `to_query_string` turns an AST node into a GraphQL8 string
      ...
      class AbstractNode
        ...
        # @return [Array<GraphQL8::Language::Nodes::AbstractNode>] all nodes in the tree below this one
        def children
          []
        end
        ...
        def to_query_string(printer: GraphQL8::Language::Printer.new)
          printer.print(self)
        end
      end
      ...
      #  class VariableScrubber < GraphQL8::Language::Printer
      ...
      class Document < AbstractNode
        ...
        #   @return [Array<OperationDefinition, FragmentDefinition>] top-level GraphQL8 units: operations or fragments
        def initialize_node(definitions: [])
          @definitions = definitions
        end

        def slice_definition(name)
          GraphQL8::Language::DefinitionSlice.slice(self, name)
        end
      end
      ...
      # A single selection in a GraphQL8 query.
