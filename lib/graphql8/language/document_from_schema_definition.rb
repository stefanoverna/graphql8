...
module GraphQL8
  module Language
    # @api private
    #
    # {GraphQL8::Language::DocumentFromSchemaDefinition} is used to convert a {GraphQL8::Schema} object
    # To a {GraphQL8::Language::Document} AST node.
    #
    # @param context [Hash]
    ...
    class DocumentFromSchemaDefinition
      def initialize(
        ...
        @warden = GraphQL8::Schema::Warden.new(
          GraphQL8::Filter.new(only: only, except: except),
          schema: @schema,
          context: context,
        )
      end
      ...
      def document
        GraphQL8::Language::Nodes::Document.new(
          definitions: build_definition_nodes
        )
      end

      def build_schema_node
        GraphQL8::Language::Nodes::SchemaDefinition.new(
      ...
      def build_object_type_node(object_type)
        GraphQL8::Language::Nodes::ObjectTypeDefinition.new(
      ...
      def build_field_node(field)
        field_node = GraphQL8::Language::Nodes::FieldDefinition.new(
          name: field.name,
        ...
        if field.deprecation_reason
          field_node.directives << GraphQL8::Language::Nodes::Directive.new(
            name: GraphQL8::Directive::DeprecatedDirective.name,
            arguments: [GraphQL8::Language::Nodes::Argument.new(name: "reason", value: field.deprecation_reason)]
          )
        end
      ...
      def build_union_type_node(union_type)
        GraphQL8::Language::Nodes::UnionTypeDefinition.new(
      ...
      def build_interface_type_node(interface_type)
        GraphQL8::Language::Nodes::InterfaceTypeDefinition.new(
      ...
      def build_enum_type_node(enum_type)
        GraphQL8::Language::Nodes::EnumTypeDefinition.new(
          name: enum_type.name,
      ...
      def build_enum_value_node(enum_value)
        enum_value_node = GraphQL8::Language::Nodes::EnumValueDefinition.new(
          name: enum_value.name,
          description: enum_value.description,
        )

        if enum_value.deprecation_reason
          enum_value_node.directives << GraphQL8::Language::Nodes::Directive.new(
            name: GraphQL8::Directive::DeprecatedDirective.name,
            arguments: [GraphQL8::Language::Nodes::Argument.new(name: "reason", value: enum_value.deprecation_reason)]
          )
        end
      ...
      def build_scalar_type_node(scalar_type)
        GraphQL8::Language::Nodes::ScalarTypeDefinition.new(
      ...
      def build_argument_node(argument)
        argument_node = GraphQL8::Language::Nodes::InputValueDefinition.new(
          name: argument.name,
      ...
      def build_input_object_node(input_object)
        GraphQL8::Language::Nodes::InputObjectTypeDefinition.new(
      ...
      def build_directive_node(directive)
        GraphQL8::Language::Nodes::DirectiveDefinition.new(
          name: directive.name,
      ...
      def build_directive_location_node(location)
        GraphQL8::Language::Nodes::DirectiveLocation.new(
          name: location.to_s
        )
      end
      ...
      def build_type_name_node(type)
        ...
        when GraphQL8::ListType
          GraphQL8::Language::Nodes::ListType.new(
            of_type: build_type_name_node(type.of_type)
          )
        when GraphQL8::NonNullType
          GraphQL8::Language::Nodes::NonNullType.new(
            of_type: build_type_name_node(type.of_type)
          )
        else
          GraphQL8::Language::Nodes::TypeName.new(name: type.name)
        end
      end

      def build_default_value(default_value, type)
        if default_value.nil?
          return GraphQL8::Language::Nodes::NullValue.new(name: "null")
        end
        ...
        when EnumType
          GraphQL8::Language::Nodes::Enum.new(name: type.coerce_isolated_result(default_value))
        when InputObjectType
          GraphQL8::Language::Nodes::InputObject.new(
            arguments: default_value.to_h.map do |arg_name, arg_value|
              arg_type = type.input_fields.fetch(arg_name.to_s).type
              GraphQL8::Language::Nodes::Argument.new(
                name: arg_name,
