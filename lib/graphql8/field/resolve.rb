...
module GraphQL8
  class Field
    # Create resolve procs ahead of time based on a {GraphQL8::Field}'s `name`, `property`, and `hash_key` configuration.
    module Resolve
      module_function

      # @param field [GraphQL8::Field] A field that needs a resolve proc
