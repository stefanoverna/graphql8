...
describe GraphQL8::ScalarType do
  let(:custom_scalar) {
    GraphQL8::ScalarType.define do
      name "BigInt"
  ...
  describe "validate_input with good input" do
    let(:result) { GraphQL8::INT_TYPE.validate_isolated_input(150) }
  ...
  describe "validate_input with bad input" do
    let(:result) { GraphQL8::INT_TYPE.validate_isolated_input("bad num") }
