...
describe GraphQL8::Directive do
  ...
  describe "merging @skip and @include" do
    ...
    # https://github.com/facebook/graphql8/blob/master/spec/Section%203%20--%20Type%20System.md#include
  ...
  describe "defining a directive" do
    let(:directive) {
      GraphQL8::Directive.define do
        arguments [GraphQL8::Argument.define(name: 'skip')]
      end
    }
