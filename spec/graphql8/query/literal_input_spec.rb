...
describe GraphQL8::Query::LiteralInput do
        ...
        type = GraphQL8::ObjectType.define do
          ...
          field :addToArgumentValue do
            ...
            argument :value do
              ...
              default_value 3
              prepare ->(arg, ctx) do
                return GraphQL8::ExecutionError.new("Can't return more than 3 digits") if arg > 998
                arg + ctx[:val]
              end
            end
          ...
          field :fieldWithArgumentThatIsBadByDefault do
            ...
            argument :value do
              ...
              default_value 7
              prepare ->(arg, ctx) do
                GraphQL8::ExecutionError.new("Always bad")
              end
            end
