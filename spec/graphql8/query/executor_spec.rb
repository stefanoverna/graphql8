...
describe GraphQL8::Query::Executor do
  ...
  describe "fragment resolution" do
    let(:schema) {
      ...
      DummyQueryType = GraphQL8::ObjectType.define do
        name "Query"
        field :dairy do
      ...
      GraphQL8::Schema.define(query: DummyQueryType, mutation: Dummy::DairyAppMutation.graphql_definition, resolve_type: ->(a,b,c) { :pass }, id_from_object: :pass)
    }
    let(:variables) { nil }
    let(:query_string) { %|
      query getDairy {
