...
describe GraphQL8::Query::Arguments do
  let(:arguments) {
    test_input_1 = GraphQL8::InputObjectType.define do
      name "TestInput1"
      argument :d, types.Int
      argument :e, types.Int
    end

    test_input_2 = GraphQL8::InputObjectType.define do
      name "TestInput2"
    ...
    GraphQL8::Query::Arguments.construct_arguments_class(test_input_1)
    GraphQL8::Query::Arguments.construct_arguments_class(test_input_2)
  ...
  it "yields key, value, and arg_defnition" do
    ...
    arguments.each_value do |arg_value|
      value = arg_value.value.is_a?(GraphQL8::Query::Arguments) ? arg_value.value.to_h : arg_value.value
  ...
  it "can be copied to a new Arguments instance" do
    ...
    args_class = Class.new(GraphQL8::Query::Arguments) do
  ...
  describe "nested hashes" do
    let(:input_type) {
      test_input_type = GraphQL8::InputObjectType.define do
        name "TestInput"
        argument :a, types.Int
        argument :b, test_input_type
        argument :c, types.Int # will be a hash
      end
      GraphQL8::Query::Arguments.construct_arguments_class(test_input_type)
      test_input_type
    }
    it "wraps input objects, but not other hashes" do
      ...
      assert_kind_of GraphQL8::Query::Arguments, args["b"]
  ...
  describe "#[]" do
    it "fetches using specified `as` keyword" do
      assert arguments["inputObject"].is_a?(GraphQL8::Query::Arguments)
    end
  ...
  describe "#dig" do
    it "returns the value at that key" do
      ...
      assert_equal 1, arguments.dig(:a)
      assert arguments.dig("inputObject").is_a?(GraphQL8::Query::Arguments)
    end
  ...
  describe "#key?" do
    ...
    let(:schema) {
      ...
      GraphQL8::Schema.define(query: query)
    }
  ...
  describe "construct_arguments_class" do
    ...
    it "generates argument classes that responds to keys as functions" do
      ...
      GraphQL8::Query::Arguments.construct_arguments_class(input_object)
