...
describe GraphQL8::ListType do
  let(:float_list) { GraphQL8::ListType.new(of_type: GraphQL8::FLOAT_TYPE) }
  ...
  describe "validate_input with bad input" do
    ...
    it "has the correct explanation" do
      expected = GraphQL8::FLOAT_TYPE.validate_isolated_input(bad_num).problems[0]["explanation"]
  ...
  describe "list of input objects" do
    let(:input_object) do
      input_object = GraphQL8::InputObjectType.define do
