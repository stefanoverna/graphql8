...
describe GraphQL8::Execution::Multiplex do
  def multiplex(*a)
  ...
  describe "after_query when errors are raised" do
    ...
    InspectQueryType = GraphQL8::ObjectType.define do
      name "Query"

      field :raiseExecutionError, types.String do
        resolve ->(object, args, ctx) {
          raise GraphQL8::ExecutionError, "Whoops"
        }
      end

      field :raiseError, types.String do
        resolve ->(object, args, ctx) {
          raise GraphQL8::Error, "Crash"
        }
      end
    ...
    InspectSchema = GraphQL8::Schema.define do
    ...
    it "can access the query results" do
      ...
      assert_raises(GraphQL8::Error) do
