...
describe GraphQL8::Execution::Typecast do
  describe ".subtype?" do
    def subtype?(*args)
      GraphQL8::Execution::Typecast.subtype?(*args)
    end
    ...
    it "counts member types as subtypes" do
      ...
      assert !subtype?(Dummy::Edible.graphql_definition, GraphQL8::STRING_TYPE)
    ...
    it "counts lists as subtypes if their inner types are subtypes" do
      ...
      assert !subtype?(Dummy::Edible.graphql_definition.to_list_type, GraphQL8::STRING_TYPE.to_list_type)
    end
    ...
    it "counts non-null types as subtypes of nullable parent types" do
      ...
      assert subtype?(
        GraphQL8::STRING_TYPE.to_non_null_type.to_list_type,
        GraphQL8::STRING_TYPE.to_non_null_type.to_list_type.to_non_null_type,
      )
    end
  end
end
