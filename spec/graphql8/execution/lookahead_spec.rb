...
describe GraphQL8::Execution::Lookahead do
  module LookaheadTest
    ...
    class BirdGenus < GraphQL8::Schema::Object
      field :latin_name, String, null: false
    end

    class BirdSpecies < GraphQL8::Schema::Object
  ...
  describe "looking ahead" do
    ...
    let(:query) {
      GraphQL8::Query.new(LookaheadTest::Schema, document: document, variables: { name: "Cardinal" })
    }
    ...
    it "can detect fields on objects with symbol or string" do
      ...
      lookahead = GraphQL8::Execution::Lookahead.new(query: query, ast_nodes: [ast_node], field: field)
    ...
    it "detects by name, not by alias" do
      ...
      lookahead = GraphQL8::Execution::Lookahead.new(query: query, ast_nodes: [ast_node], root_type: LookaheadTest::Query)
    ...
    describe "constraints by arguments" do
      let(:lookahead) do
        ast_node = document.definitions.first
        GraphQL8::Execution::Lookahead.new(query: query, ast_nodes: [ast_node], root_type: LookaheadTest::Query)
      end
  ...
  describe '#selections' do
    ...
    def query(doc = document)
      GraphQL8::Query.new(LookaheadTest::Schema, document: document)
    end
    ...
    it 'handles duplicate selections' do
      ...
      lookahead = GraphQL8::Execution::Lookahead.new(query: query(doc), ast_nodes: [ast_node], root_type: LookaheadTest::Query)
    ...
    it "works for missing selections" do
      ...
      assert_instance_of GraphQL8::Execution::Lookahead::NullLookahead, null_lookahead
