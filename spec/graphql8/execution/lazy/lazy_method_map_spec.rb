...
describe GraphQL8::Execution::Lazy::LazyMethodMap do
  ...
  describe "with a plain hash" do
    let(:lazy_method_map) { GraphQL8::Execution::Lazy::LazyMethodMap.new(use_concurrent: false) }
  ...
  describe "with a Concurrent::Map" do
    let(:lazy_method_map) { GraphQL8::Execution::Lazy::LazyMethodMap.new(use_concurrent: true) }
    test_lazy_method_map
