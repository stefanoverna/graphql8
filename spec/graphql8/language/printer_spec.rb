...
describe GraphQL8::Language::Printer do
  ...
  let(:printer) { GraphQL8::Language::Printer.new }
  ...
  describe "#print" do
    ...
    describe "schema" do
      ...
      describe "full featured schema" do
        # Based on: https://github.com/graphql8/graphql-js/blob/bc96406ab44453a120da25a0bd6e2b0237119ddf/src/language/__tests__/schema-kitchen-sink.graphql
        let(:query_string) {<<-schema
          schema {
            query: QueryType
