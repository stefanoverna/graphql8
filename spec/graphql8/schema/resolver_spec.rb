...
describe GraphQL8::Schema::Resolver do
  module ResolverTest
    class LazyBlock
      def initialize
        @get_value = Proc.new
    ...
    class BaseResolver < GraphQL8::Schema::Resolver
    end
    ...
    class PrepResolver1 < BaseResolver
      ...
      def check_for_magic_number(int)
        if int == 13
          raise GraphQL8::ExecutionError, "13 is unlucky!"
        elsif int > 99
          raise GraphQL8::UnauthorizedError, "Top secret big number: #{int}"
        else
          int
        end
      end
    ...
    class PrepResolver7 < GraphQL8::Schema::Mutation
      argument :int, Integer, required: true
    ...
    class IntegerWrapper < GraphQL8::Schema::Object
      implements HasValue
    ...
    class PrepResolver10 < BaseResolver
      ...
      def authorized?(int1:, integer_2:)
        if int1 + integer_2 > context[:max_int]
          raise GraphQL8::ExecutionError, "Inputs too big"
    ...
    class PrepResolver12 < GraphQL8::Schema::Mutation
      argument :int1, Integer, required: true
    ...
    class PrepResolver14 < GraphQL8::Schema::RelayClassicMutation
    ...
    class MutationWithNullableLoadsArgument < GraphQL8::Schema::Mutation
    ...
    class MutationWithRequiredLoadsArgument < GraphQL8::Schema::Mutation
    ...
    class Mutation < GraphQL8::Schema::Object
  ...
  describe "preparing inputs" do
    ...
    describe "loading arguments" do
      ...
      it "supports raising GraphQL8::UnauthorizedError and GraphQL8::ExecutionError" do
