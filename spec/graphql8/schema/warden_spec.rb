...
module MaskHelpers
  PhonemeType = GraphQL8::ObjectType.define do
    name "Phoneme"
  ...
  MannerEnum = GraphQL8::EnumType.define do
    name "Manner"
  ...
  LanguageType = GraphQL8::ObjectType.define do
    name "Language"
    field :name, types.String.to_non_null_type
  ...
  GraphemeType = GraphQL8::ObjectType.define do
    name "Grapheme"
  ...
  LanguageMemberInterface = GraphQL8::InterfaceType.define do
    name "LanguageMember"
  ...
  CheremeInput = GraphQL8::InputObjectType.define do
    name "CheremeInput"
    input_field :name, types.String
  end

  Chereme = GraphQL8::ObjectType.define do
    name "Chereme"
    description "A basic unit of signed communication"
    field :name, types.String.to_non_null_type
  end

  Character = GraphQL8::ObjectType.define do
    name "Character"
    interfaces [LanguageMemberInterface]
...
describe GraphQL8::Schema::Warden do
  ...
  describe "hiding types" do
    ...
    it "hides interfaces if all possible types are hidden" do
      ...
      schema = GraphQL8::Schema.from_definition(sdl)
    ...
    it "can't be a resolve_type result" do
      ...
      assert_raises(GraphQL8::UnresolvedTypeError) {
  ...
  describe "hiding enum values" do
    ...
    it "raises a runtime error" do
      ...
      |
      assert_raises(GraphQL8::EnumType::UnresolvedValueError) {
