...
describe GraphQL8::Schema::Member::AcceptsDefinition do
  class AcceptsDefinitionSchema < GraphQL8::Schema
    accepts_definition :set_metadata
    set_metadata :a, 999

    class BaseField < GraphQL8::Schema::Field
      class BaseField < GraphQL8::Schema::Argument
    ...
    GraphQL8::Schema::Object.accepts_definition(:metadata2)
    ...
    GraphQL8::Schema::Interface.accepts_definition(:metadata2)
    ...
    class Option < GraphQL8::Schema::Enum
      class EnumValue < GraphQL8::Schema::EnumValue
        accepts_definition :metadata
      end
