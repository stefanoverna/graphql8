...
describe GraphQL8::Schema::Object do
  ...
  describe "implementing interfaces" do
    it "raises an error when trying to implement a non-interface module" do
      object_type = Class.new(GraphQL8::Schema::Object)
      ...
      message = "NotAnInterface cannot be implemented since it's not a GraphQL8 Interface. Use `include` for plain Ruby modules."
  ...
  describe ".to_graphql" do
    ...
    it "returns a matching GraphQL8::ObjectType" do
      ...
      assert_equal GraphQL8::STRING_TYPE.to_non_null_type, name_field.type
