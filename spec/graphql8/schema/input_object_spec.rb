...
describe GraphQL8::Schema::InputObject do
  ...
  describe "type info" do
    ...
    it "inherits arguments" do
      base_class = Class.new(GraphQL8::Schema::InputObject) do
  ...
  describe "prepare: / as:" do
    module InputObjectPrepareTest
      class InputObj < GraphQL8::Schema::InputObject
  ...
  describe "#to_h" do
    module InputObjectToHTest
      class TestInput1 < GraphQL8::Schema::InputObject
        graphql_name "TestInput1"
        argument :d, Int, required: true
        argument :e, Int, required: true
      end

      class TestInput2 < GraphQL8::Schema::InputObject
  ...
  describe "#dig" do
    ...
    it "returns the value at that key" do
      ...
      assert_equal 1, input_object.dig(:a)
      assert input_object.dig("inputObject").is_a?(GraphQL8::Schema::InputObject)
    end
