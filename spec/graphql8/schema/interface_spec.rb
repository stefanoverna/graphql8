...
describe GraphQL8::Schema::Interface do
  ...
  describe "type info" do
    ...
    it "can override methods" do
      new_object_1 = Class.new(GraphQL8::Schema::Object) do
      ...
      new_object_2 = Class.new(GraphQL8::Schema::Object) do
        graphql_name "XYZ"
  ...
  describe ".to_graphql" do
    it "creates an InterfaceType" do
      ...
      assert_equal GraphQL8::ID_TYPE.to_non_null_type, field.type
  ...
  it 'supports global_id_field' do
    ...
    assert_equal GraphQL8::NonNullType, uuid_field.type.class
    assert_equal GraphQL8::ScalarType, uuid_field.type.unwrap.class
    assert_equal(
      GraphQL8::Schema::Member::GraphQL8TypeNames::ID,
