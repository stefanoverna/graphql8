...
describe GraphQL8::Schema::Mutation do
  ...
  describe "a derived field" do
    it "has a reference to the mutation" do
      f = GraphQL8::Schema::Field.from_options(name: "x", **mutation.field_options)
  ...
  describe ".object_class" do
    it "can override & inherit the parent class" do
      obj_class = Class.new(GraphQL8::Schema::Object)
      mutation_class = Class.new(GraphQL8::Schema::Mutation) do
        object_class(obj_class)
      end
      mutation_subclass = Class.new(mutation_class)

      assert_equal(GraphQL8::Schema::Object, GraphQL8::Schema::Mutation.object_class)
  ...
  describe ".argument_class" do
    it "can override & inherit the parent class" do
      arg_class = Class.new(GraphQL8::Schema::Argument)
      mutation_class = Class.new(GraphQL8::Schema::Mutation) do
      ...
      assert_equal(GraphQL8::Schema::Argument, GraphQL8::Schema::Mutation.argument_class)
  ...
  describe "evaluation" do
    it "runs mutations" do
      ...
      assert_equal "GraphQL8::Query::Context::ExecutionErrors", response["data"]["addInstrument"]["ee"]
  ...
  describe ".null" do
    it "overrides whether or not the field can be null" do
      non_nullable_mutation_class = Class.new(GraphQL8::Schema::Mutation) do
        graphql_name "Thing1"
        null(false)
      end

      nullable_mutation_class = Class.new(GraphQL8::Schema::Mutation) do
        graphql_name "Thing2"
        null(true)
      end

      default_mutation_class = Class.new(GraphQL8::Schema::Mutation) do
        graphql_name "Thing3"
      end
    ...
    it "should inherit and override in subclasses" do
      base_mutation = Class.new(GraphQL8::Schema::Mutation) do
        null(false)
      end
