...
describe GraphQL8::Schema::Finder do
  let(:finder) { GraphQL8::Schema::Finder.new(Jazz::Schema) }
  ...
  describe "#find" do
    ...
    it "raises when finding an invalid object type" do
      exception = assert_raises GraphQL8::Schema::Finder::MemberNotFoundError do
