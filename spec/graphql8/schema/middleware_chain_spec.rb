...
describe GraphQL8::Schema::MiddlewareChain do
  ...
  let(:middleware_chain) { GraphQL8::Schema::MiddlewareChain.new(steps: steps)}
  ...
  describe "#invoke" do
    ...
    describe "when there is a final step" do
      ...
      let(:middleware_chain) { GraphQL8::Schema::MiddlewareChain.new(steps: [step_1, step_2], final_step: final_step) }
    ...
    describe "when a step provides alternate arguments" do
      it "passes the new arguments to the next step" do
        ...
        chain = GraphQL8::Schema::MiddlewareChain.new(steps: [step_1, step_2])
