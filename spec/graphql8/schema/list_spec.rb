...
describe GraphQL8::Schema::List do
  let(:of_type) { Jazz::Musician }
  let(:list_type) { GraphQL8::Schema::List.new(of_type) }
  ...
  it "returns kind to be GraphQL8::TypeKinds::LIST" do
    assert_equal GraphQL8::TypeKinds::LIST, list_type.kind
  end
  ...
  describe "comparison operator" do
    it "will return false if list types 'of_type' are different" do
      ...
      new_list_type = GraphQL8::Schema::List.new(new_of_type)
  ...
  describe "to_graphql" do
    it "will return a list type" do
      assert_kind_of GraphQL8::ListType, list_type.to_graphql
    end
  end
end
