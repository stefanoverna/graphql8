...
describe GraphQL8::Schema::Field do
  describe "graphql definition" do
    ...
    it "camelizes the field name, unless camelize: false" do
      ...
      underscored_field = GraphQL8::Schema::Field.from_options(:underscored_field, String, null: false, camelize: false, owner: nil) do
    ...
    it "accepts anonymous classes as type" do
      type = Class.new(GraphQL8::Schema::Object) do
        graphql_name 'MyType'
      end
      field = GraphQL8::Schema::Field.from_options(:my_field, type, owner: nil, null: true)
  ...
  describe "build type errors" do
    it "includes the full name" do
      thing = Class.new(GraphQL8::Schema::Object) do
        graphql_name "Thing"
        # `Set` is a class but not a GraphQL8 type
    ...
    it "makes a suggestion when the type is a GraphQL8::Field" do
      err = assert_raises ArgumentError do
        Class.new(GraphQL8::Schema::Object) do
          graphql_name "Thing"
          # Previously, field was a valid second argument
          field :stuff, GraphQL8::Relay::Node.field, null: false
        end
      end
  ...
  describe "mutation" do
    it "passes when not including extra arguments" do
      mutation_class = Class.new(GraphQL8::Schema::Mutation) do
        graphql_name "Thing"
        field :stuff, String, null: false
      end

      obj = Class.new(GraphQL8::Schema::Object) do
  ...
  describe '#deprecation_reason' do
    it "reads and writes" do
      object_class = Class.new(GraphQL8::Schema::Object) do
        graphql_name "Thing"
  ...
  describe "#original_name" do
    it "is exactly the same as the passed in name" do
      field = GraphQL8::Schema::Field.from_options(
        :my_field,
        String,
        null: false,
        camelize: true
