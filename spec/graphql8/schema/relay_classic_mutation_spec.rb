...
describe GraphQL8::Schema::RelayClassicMutation do
  describe ".input_object_class" do
    it "is inherited, with a default" do
      custom_input = Class.new(GraphQL8::Schema::InputObject)
      mutation_base_class = Class.new(GraphQL8::Schema::RelayClassicMutation) do
        input_object_class(custom_input)
      end
      mutation_subclass = Class.new(mutation_base_class)

      assert_equal GraphQL8::Schema::InputObject, GraphQL8::Schema::RelayClassicMutation.input_object_class
  ...
  describe ".input_type" do
    it "has a reference to the mutation" do
      mutation = Class.new(GraphQL8::Schema::RelayClassicMutation) do
        graphql_name "Test"
      end
