...
describe GraphQL8::Schema::NonNull do
  let(:of_type) { Jazz::Musician }
  let(:non_null_type) { GraphQL8::Schema::NonNull.new(of_type) }
  ...
  it "returns kind to be GraphQL8::TypeKinds::NON_NULL" do
  ...
  describe "comparison operator" do
    it "will return false if list types 'of_type' are different" do
      ...
      new_non_null_type = GraphQL8::Schema::NonNull.new(new_of_type)
  ...
  describe "to_graphql" do
    it "will return a non null type" do
      assert_kind_of GraphQL8::NonNullType, non_null_type.to_graphql
    end
  end
end
