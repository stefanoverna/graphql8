...
module Garden
  ...
  class Vegetable
    ...
    accepts_definitions :name, plant_between: DefinePlantBetween, has_leaves: GraphQL8::Define.assign_metadata_key(:has_leaves), color: GraphQL8::Define.assign_metadata_key(:color)
...
describe GraphQL8::Define::InstanceDefinable do
  ...
  describe "typos" do
    it "provides the right class name, method name and line number" do
      err = assert_raises(GraphQL8::Define::NoDefinitionError) {
